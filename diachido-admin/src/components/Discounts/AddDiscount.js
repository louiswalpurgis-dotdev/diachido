...
import { Back, Money, Percent, SelectorIcon } from '../Icons';
    ...
    const handleSubmit = () => {
        ...
        try {
            ...
            addDocument('discounts', {
                ...
                isPuslished: role in ['admin', 'moderator'] ? true : false,
            });
            removeDataField();
            setLoading(false);
            ...
            <div className="flex flex-col gap-4">
                <Card className=" mt-4 space-y-2 bg-background/60 py-4 dark:bg-default-100/50">
                    <CardHeader>
                        ...
                        <p className="text-lg font-semibold">Thêm ưu đãi</p>
                    </CardHeader>
